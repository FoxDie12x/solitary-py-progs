...
def diamond_word(n: int, s: str):
    """Displays a diamond pattern of string s.
...
def diamond_char(n: int, char: str, /):
    """Displays a diamond consisting of characters char of length 2
